...
ARCHITECTURE structure OF exercicio_1_a IS
...
-- Equation(s):
-- \a~0_combout\ = ( !\s[0]~input_o\ & ( (!\s[1]~input_o\ & \i[0]~input_o\) ) )
...
-- Equation(s):
-- \a~1_combout\ = ( !\s[0]~input_o\ & ( (\i[1]~input_o\ & !\s[1]~input_o\) ) )
...
-- Equation(s):
-- \b~0_combout\ = ( \s[0]~input_o\ & ( (\i[0]~input_o\ & !\s[1]~input_o\) ) )
...
-- Equation(s):
-- \b~1_combout\ = ( \s[0]~input_o\ & ( (!\s[1]~input_o\ & \i[1]~input_o\) ) )
...
-- Equation(s):
-- \c~0_combout\ = ( !\s[0]~input_o\ & ( (\s[1]~input_o\ & \i[0]~input_o\) ) )
...
-- Equation(s):
-- \c~1_combout\ = ( !\s[0]~input_o\ & ( (\i[1]~input_o\ & \s[1]~input_o\) ) )
...
-- Equation(s):
-- \d~0_combout\ = ( \s[0]~input_o\ & ( (\i[0]~input_o\ & \s[1]~input_o\) ) )
...
-- Equation(s):
-- \d~1_combout\ = ( \s[0]~input_o\ & ( (\s[1]~input_o\ & \i[1]~input_o\) ) )
